...
class TestCollections:
    ...
    def test_delete_collection_with_prompts(self, client: TestClient, sample_collection_data, sample_prompt_data):
        ...
        Verify that associated prompts are also deleted when a collection is deleted.
        """
        # Create collection
        ...
        # Ensure the prompt is also deleted
        prompts = client.get("/prompts").json()["prompts"]
        assert all(prompt["collection_id"] != collection_id for prompt in prompts)
